...
const ProjectDetails = ({ project }) => {
  return (
    <div className={`w-full order-1 project-detail py-5 text-white bg-[#222936] rounded-md px-5 shadow-lg`}>
      ...
      <ul className='flex flex-wrap gap-2 '>
        {project.techStack.map((items, i) => (
          ...
          <li className='text-sm border-[1px] border-gray-600 py-1 px-4 rounded-2xl' key={i}>{items}</li>
